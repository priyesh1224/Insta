                ...
                if im != UIImage(named: "add-image") {
                    ...
                    let imguid = NSUUID().uuidString
                        ...
                        DataServices.ds.storageposts.child(imguid).put(imgdata, metadata: metadata) { (metadata , error) in
                            ...
                            let newpost = Posts(postkey: imguid, postData: ["caption":cap as AnyObject,"imageurl":downloadurl as AnyObject,"user": self.currentuser as AnyObject,"profileimgurl":"https://firebasestorage.googleapis.com/v0/b/insta-ac66a.appspot.com/o/15423772_1197215020347796_490677243_n.jpg?alt=media&token=38aaa926-6362-41ab-9590-8ca1fa628674" as AnyObject])
